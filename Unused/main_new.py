...
backlog_transfers = []  # empty list for handling backlog transaction_id MYSQL implementation needed
...
temp_transfer_ballot(0, 0, backlog_transfers, candidates)  # Valid
temp_transfer_ballot(0, 1, backlog_transfers, candidates)  # Double Voting both sides
temp_transfer_ballot(1, 0, backlog_transfers, candidates)  # Valid
temp_transfer_ballot(1, 0, backlog_transfers, candidates)  # Double Voting
temp_transfer_ballot(1, 0, backlog_transfers, candidates)  # Double Voting
temp_transfer_ballot(1, 0, backlog_transfers, candidates)  # Double Voting
temp_transfer_ballot(2, 1, backlog_transfers, candidates)  # Valid
temp_transfer_ballot(2, 0, backlog_transfers, candidates)  # Double Voting both sides
temp_transfer_ballot(3, 1, backlog_transfers, candidates)  # Valid
temp_transfer_ballot(3, 1, backlog_transfers, candidates)  # Double Voting
temp_transfer_ballot(4, 2, backlog_transfers, candidates)  # InValid Candidate
temp_transfer_ballot(4, 1, backlog_transfers, candidates)  # Valid
temp_transfer_ballot(5, 0, backlog_transfers, candidates)  # Invalide Voter

#####################################################################

print(backlog_transfers)  # List of verified transfers
stat = dashboard.make_statistics(backlog_transfers, candidates)  # Vote counter call
